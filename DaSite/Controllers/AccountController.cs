...
namespace DaSite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var aUser = UserManager.FindByEmail(model.Email);

            var password = await UserManager.CheckPasswordAsync(aUser, model.Password);

            if (password)
            {
                var result2 = SignInManager.SignInAsync(
                                 aUser,
                                 true,
                                 model.RememberMe);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            //redisplay form after fail state
            return View(model);
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Finalize(RegisterViewModel model)
        {
